...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-surface border-border shadow-2xl shadow-black/50 transition ease-in-out data-[state=open]:animate-fade-in flex flex-col',
  {
    variants: {
      side: {
        right:
          'inset-y-0 right-0 h-full w-full max-w-md border-l data-[state=open]:slide-in-from-right',
