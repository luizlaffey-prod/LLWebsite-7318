...
const trialEn: TrialEndingStrings = {
  ...
  greeting: (r) => `Hi${r ? `, ${r}` : ''},`,
  body1: (days) => `Your ${days}-day Pro trial ends in 24 hours.`,
  body2:
...
const trialPt: TrialEndingStrings = {
  ...
  greeting: (r) => `Olá${r ? `, ${r}` : ''},`,
  body1: (days) => `Seu trial Pro de ${days} dias termina em 24 horas.`,
  body2:
...
const trialEs: TrialEndingStrings = {
  ...
  greeting: (r) => `Hola${r ? `, ${r}` : ''},`,
  body1: (days) => `Tu prueba Pro de ${days} días termina en 24 horas.`,
  body2:
